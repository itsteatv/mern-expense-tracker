                        ...
                        <div className="mt-6">
                            <htmlForm className="space-y-6">
                                <div>
                                    ...
                                    <div className="mt-1">
                                        <input id="product" name="product" type="text" required="" placeholder="+100 laptop" className="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transhtmlForm border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300"></input>
                                    </div>
                                </div>
